List(ArxivEntry(http://arxiv.org/abs/1404.5454v1,Stochastic Privacy,Online services such as web search and e-commerce applications typically rely
...
guarantees on the probability of sharing data.,2014-04-22T10:55:19Z,2014-04-22T10:55:19Z,List(Author(Adish Singla), Author(Eric Horvitz), Author(Ece Kamar), Author(Ryen White))), ArxivEntry(http://arxiv.org/abs/1410.1920v1,Privacy Games,The problem of analyzing the effect of privacy concerns on the behavior of
...
framework of Randomized Response.,2014-10-07T21:31:59Z,2014-10-07T21:31:59Z,List(Author(Yiling Chen), Author(Or Sheffet), Author(Salil Vadhan))), ArxivEntry(http://arxiv.org/abs/1510.03311v1,Inverse Privacy,An item of your personal information is inversely private if some party has
...
problem has a market-based solution.,2015-10-12T14:44:05Z,2015-10-12T14:44:05Z,List(Author(Yuri Gurevich), Author(Efim Hudis), Author(Jeannette M. Wing))), ArxivEntry(http://arxiv.org/abs/1612.01553v1,Privacy Patterns,Inspired by the design patterns of object-oriented software architecture, we
...
an institutionalised form of Intimacy which we call Confidence.,2016-12-05T21:19:24Z,2016-12-05T21:19:24Z,List(Author(Clark Thomborson))), ArxivEntry(http://arxiv.org/abs/1904.05540v1,Privacy protocols,Security protocols enable secure communication over insecure channels.
...
attacks are supplemented by sublimations and the level-above attacks.,2019-04-11T05:37:58Z,2019-04-11T05:37:58Z,List(Author(Jason Castiglione), Author(Dusko Pavlovic), Author(Peter-Michael Seidel))), ArxivEntry(http://arxiv.org/abs/1910.13027v1,Noiseless Privacy,In this paper, we define noiseless privacy, as a non-stochastic rival to
...
transport.,2019-10-29T01:09:26Z,2019-10-29T01:09:26Z,List(Author(Farhad Farokhi))), ArxivEntry(http://arxiv.org/abs/2009.00442v1,Imitation Privacy,In recent years, there have been many cloud-based machine learning services,
...
usual data-level privacy.,2020-08-30T20:29:41Z,2020-08-30T20:29:41Z,List(Author(Xun Xian), Author(Xinran Wang), Author(Mingyi Hong), Author(Jie Ding), Author(Reza Ghanadan))), ArxivEntry(http://arxiv.org/abs/1710.03322v5,XYZ Privacy,Future autonomous vehicles will generate, collect, aggregate and consume
...
default implementation.,2018-02-21T19:54:24Z,2017-10-09T21:24:22Z,List(Author(Josh Joy), Author(Dylan Gray), Author(Ciaran McGoldrick), Author(Mario Gerla))), ArxivEntry(http://arxiv.org/abs/2207.03940v1,Bistochastic privacy,We introduce a new privacy model relying on bistochastic matrices, that is,
...
matrices to achieve the privacy guarantees of this new model is also provided.,2022-07-08T14:50:31Z,2022-07-08T14:50:31Z,List(Author(Nicolas Ruiz), Author(Josep Domingo-Ferrer))), ArxivEntry(http://arxiv.org/abs/2006.08522v3,Transparent Privacy is Principled Privacy,In a technical treatment, this article establishes the necessity of
...
accountability, and public trust in modern data curation.,2022-09-18T18:02:14Z,2020-06-15T16:30:29Z,List(Author(Ruobin Gong))), ArxivEntry(http://arxiv.org/abs/2209.01468v1,Randomized Privacy Budget Differential Privacy,While pursuing better utility by discovering knowledge from the data,
...
accuracy in a humongous scale.,2022-09-03T17:33:49Z,2022-09-03T17:33:49Z,List(Author(Meisam Mohammady))), ArxivEntry(http://arxiv.org/abs/1108.2234v1,Smart Meter Privacy: A Utility-Privacy Framework,End-user privacy in smart meter measurements is a well-known challenge in the
...
encompass most of the proposed privacy approaches.,2011-08-10T18:14:16Z,2011-08-10T18:14:16Z,List(Author(S. Raj Rajagopalan), Author(Lalitha Sankar), Author(Soheil Mohajer), Author(H. Vincent Poor))), ArxivEntry(http://arxiv.org/abs/1201.4376v2,Participatory Privacy: Enabling Privacy in Participatory Sensing,Participatory Sensing is an emerging computing paradigm that enables the
...
research directions.,2013-02-08T03:22:25Z,2012-01-20T20:15:53Z,List(Author(Emiliano De Cristofaro), Author(Claudio Soriente))), ArxivEntry(http://arxiv.org/abs/2004.09481v4,Connecting Robust Shuffle Privacy and Pan-Privacy,In the \emph{shuffle model} of differential privacy, data-holding users send
...
privacy.,2020-08-12T03:45:00Z,2020-04-20T17:58:14Z,List(Author(Victor Balcer), Author(Albert Cheu), Author(Matthew Joseph), Author(Jieming Mao))), ArxivEntry(http://arxiv.org/abs/2005.10486v2,Privacy Preserving Face Recognition Utilizing Differential Privacy,Facial recognition technologies are implemented in many areas, including but
...
- 90% under standard privacy settings.,2020-07-04T14:04:25Z,2020-05-21T06:59:33Z,List(Author(M. A. P. Chamikara), Author(P. Bertok), Author(I. Khalil), Author(D. Liu), Author(S. Camtepe))), ArxivEntry(http://arxiv.org/abs/1812.08000v3,Privacy-Aware Eye Tracking Using Differential Privacy,With eye tracking being increasingly integrated into virtual and augmented
...
for future research on privacy-aware gaze interfaces.,2019-04-29T21:19:15Z,2018-12-19T15:10:05Z,List(Author(Julian Steil), Author(Inken Hagestedt), Author(Michael Xuelin Huang), Author(Andreas Bulling))), ArxivEntry(http://arxiv.org/abs/2209.15596v2,Individual Privacy Accounting with Gaussian Differential Privacy,Individual privacy accounting enables bounding differential privacy (DP) loss
...
$(\varepsilon,\delta)$-accountant.,2023-08-24T14:00:18Z,2022-09-30T17:19:40Z,List(Author(Antti Koskela), Author(Marlon Tobaben), Author(Antti Honkela))), ArxivEntry(http://arxiv.org/abs/2303.07782v1,Inferential Privacy: From Impossibility to Database Privacy,We investigate the possibility of guaranteeing inferential privacy for
...
by excluding low-entropy prior distributions from protection.,2023-03-14T10:47:40Z,2023-03-14T10:47:40Z,List(Author(Sara Saeidian), Author(Giulia Cervia), Author(Tobias J. Oechtering), Author(Mikael Skoglund))), ArxivEntry(http://arxiv.org/abs/quant-ph/0502010v1,Gaussian Operations and Privacy,We consider the possibilities offered by Gaussian states and operations for
...
secret key out of bound entangled Gaussian states.,2005-02-01T15:04:33Z,2005-02-01T15:04:33Z,List(Author(Miguel Navascues), Author(Antonio Acin))), ArxivEntry(http://arxiv.org/abs/0901.1365v1,Differential Privacy with Compression,This work studies formal utility and privacy guarantees for a simple
...
(Liu et al. 06) based on the covariance of the initial data.,2009-01-10T12:12:31Z,2009-01-10T12:12:31Z,List(Author(Shuheng Zhou), Author(Katrina Ligett), Author(Larry Wasserman))), ArxivEntry(http://arxiv.org/abs/0904.0682v4,Privacy in Search Logs,Search engine companies collect the "database of intentions", the histories
...
at the same time achieving much stronger privacy guarantees.,2011-05-11T22:39:23Z,2009-04-04T05:49:00Z,List(Author(Michaela Goetz), Author(Ashwin Machanavajjhala), Author(Guozhang Wang), Author(Xiaokui Xiao), Author(Johannes Gehrke))), ArxivEntry(http://arxiv.org/abs/0904.4050v2,Extensive nonadditivity of privacy,Quantum information theory establishes the ultimate limits on communication
...
nonadditivity of privacy of the strongest possible sort.,2009-08-27T12:49:25Z,2009-04-26T19:02:50Z,List(Author(Graeme Smith), Author(John A. Smolin))), ArxivEntry(http://arxiv.org/abs/1011.1375v4,Selling Privacy at Auction,We initiate the study of markets for private data, though the lens of
...
valuations for privacy.,2011-11-29T14:51:37Z,2010-11-05T12:04:53Z,List(Author(Arpita Ghosh), Author(Aaron Roth))), ArxivEntry(http://arxiv.org/abs/1102.4021v2,Privacy Preserving Spam Filtering,Email is a private medium of communication, and the inherent privacy
...
protocol making it feasible to use in practice while achieving high accuracy.,2011-09-18T05:37:43Z,2011-02-19T20:40:56Z,List(Author(Manas A. Pathak), Author(Mehrbod Sharifi), Author(Bhiksha Raj))), ArxivEntry(http://arxiv.org/abs/1109.2486v1,Quantum privacy witness,While it is usually known that the mean value of a single observable is
...
detection and estimation of task-dedicated quantum entanglement.,2011-09-12T14:47:40Z,2011-09-12T14:47:40Z,List(Author(Konrad Banaszek), Author(Karol Horodecki), Author(Paweł Horodecki))), ArxivEntry(http://arxiv.org/abs/1111.3350v2,Privacy-Aware Mechanism Design,In traditional mechanism design, agents only care about the utility they
...
digital good.,2012-02-14T14:24:21Z,2011-11-14T20:32:33Z,List(Author(Kobbi Nissim), Author(Claudio Orlandi), Author(Rann Smorodinsky))), ArxivEntry(http://arxiv.org/abs/1112.2680v1,Random Differential Privacy,We propose a relaxed privacy definition called {\em random differential
...
definition.,2011-12-12T20:16:03Z,2011-12-12T20:16:03Z,List(Author(Rob Hall), Author(Alessandro Rinaldo), Author(Larry Wasserman))), ArxivEntry(http://arxiv.org/abs/1207.0135v1,Privacy Preservation by Disassociation,In this work, we focus on protection against identity disclosure in the
...
on generalization and differential privacy.,2012-06-30T20:16:16Z,2012-06-30T20:16:16Z,List(Author(Manolis Terrovitis), Author(John Liagouris), Author(Nikos Mamoulis), Author(Spiros Skiadopoulos))), ArxivEntry(http://arxiv.org/abs/1207.1371v1,On Privacy-Preserving Histograms,We advance the approach initiated by Chawla et al. for sanitizing (census)
...
a privacy-preserving fashion.,2012-07-04T16:06:07Z,2012-07-04T16:06:07Z,List(Author(Shuchi Chawla), Author(Cynthia Dwork), Author(Frank McSherry), Author(Kunal Talwar))), ArxivEntry(http://arxiv.org/abs/1210.2085v2,Privacy Aware Learning,We study statistical risk minimization problems under a privacy model in
...
learning procedure.,2013-10-10T17:53:36Z,2012-10-07T18:27:03Z,List(Author(John C. Duchi), Author(Michael I. Jordan), Author(Martin J. Wainwright))), ArxivEntry(http://arxiv.org/abs/1210.2123v1,Privacy Against Statistical Inference,We propose a general statistical inference framework to capture the privacy
...
Finally, we compare our framework with differential privacy.,2012-10-08T01:07:48Z,2012-10-08T01:07:48Z,List(Author(Flavio du Pin Calmon), Author(Nadia Fawaz))), ArxivEntry(http://arxiv.org/abs/1210.6621v2,Privacy Design Strategies,In this paper we define the notion of a privacy design strategy. These
...
evaluating the privacy impact of existing IT systems.,2013-05-06T06:35:51Z,2012-10-24T18:25:32Z,List(Author(Jaap-Henk Hoepman))), ArxivEntry(http://arxiv.org/abs/1306.2083v1,Privacy and Mechanism Design,This paper is a survey of recent work at the intersection of mechanism design
...
completely unrelated to privacy.,2013-06-10T01:41:38Z,2013-06-10T01:41:38Z,List(Author(Mallesh Pai), Author(Aaron Roth))), ArxivEntry(http://arxiv.org/abs/1312.4989v2,Maximal Privacy Without Coherence,Privacy lies at the fundament of quantum mechanics. A coherently transmitted
...
confounding influence of coherence.,2014-02-05T03:20:38Z,2013-12-17T22:28:06Z,List(Author(Debbie Leung), Author(Ke Li), Author(Graeme Smith), Author(John Smolin))), ArxivEntry(http://arxiv.org/abs/1403.2745v1,Privacy for Personal Neuroinformatics,Human brain activity collected in the form of Electroencephalography (EEG),
...
EEG recordings floating around and being used and reused for various purposes.,2014-03-11T20:33:20Z,2014-03-11T20:33:20Z,List(Author(Arkadiusz Stopczynski), Author(Dazza Greenwood), Author(Lars Kai Hansen), Author(Alex Pentland))), ArxivEntry(http://arxiv.org/abs/1407.0423v1,Privacy and Anonymity,Since the beginning of the digital area, privacy and anonymity have been
...
the Internet; introducing future lines of research.,2014-07-01T22:52:00Z,2014-07-01T22:52:00Z,List(Author(Adrian Yanes))), ArxivEntry(http://arxiv.org/abs/1409.1487v4,Perception Games and Privacy,Players (people, firms, states, etc.) have privacy concerns that may affect
...
implications of privacy concerns.,2017-05-17T15:17:48Z,2014-09-04T16:53:26Z,List(Author(Ronen Gradwohl), Author(Rann Smorodinsky))), ArxivEntry(http://arxiv.org/abs/1411.3961v2,Privacy-preserving Loyalty Programs,Loyalty programs are promoted by vendors to incentivize loyalty in buyers.
...
still allowing negotiated consumer profiling.,2014-12-01T16:25:19Z,2014-11-14T16:32:44Z,List(Author(Alberto Blanco-Justicia), Author(Josep Domingo-Ferrer))), ArxivEntry(http://arxiv.org/abs/1504.06998v1,Heterogeneous Differential Privacy,The massive collection of personal data by personalization systems has
...
semantic clustering task.,2015-04-27T09:35:46Z,2015-04-27T09:35:46Z,List(Author(Mohammad Alaggan), Author(Sébastien Gambs), Author(Anne-Marie Kermarrec))), ArxivEntry(http://arxiv.org/abs/1509.05497v1,Quadratic Gaussian Privacy Games,A game-theoretic model for analysing the effects of privacy on strategic
...
carry information, is constructed and its properties are studied.,2015-09-18T03:36:23Z,2015-09-18T03:36:23Z,List(Author(Farhad Farokhi), Author(Henrik Sandberg), Author(Iman Shames), Author(Michael Cantoni))), ArxivEntry(http://arxiv.org/abs/1510.03495v1,Privacy Constrained Information Processing,This paper studies communication scenarios where the transmitter and the
...
transmitter and the receiver on the equilibrium conditions.,2015-10-13T00:53:17Z,2015-10-13T00:53:17Z,List(Author(Emrah Akyol), Author(Cedric Langbort), Author(Tamer Basar))), ArxivEntry(http://arxiv.org/abs/1601.07417v1,Privacy-Aware MMSE Estimation,We investigate the problem of the predictability of random variable $Y$ under
...
and $P_{Z|Y}$ is restricted to be an additive noise channel.,2016-01-27T15:44:04Z,2016-01-27T15:44:04Z,List(Author(Shahab Asoodeh), Author(Fady Alajaji), Author(Tamás Linder))), ArxivEntry(http://arxiv.org/abs/1603.01887v2,Concentrated Differential Privacy,We introduce Concentrated Differential Privacy, a relaxation of Differential
...
loss over multiple computations.,2016-03-16T16:29:29Z,2016-03-06T22:41:12Z,List(Author(Cynthia Dwork), Author(Guy N. Rothblum))), ArxivEntry(http://arxiv.org/abs/1610.02339v1,Privacy Preserving Linear Programming,With the rapid increase in computing, storage and networking resources, data
...
programming problem.,2016-10-07T16:17:02Z,2016-10-07T16:17:02Z,List(Author(Yuan Hong), Author(Jaideep Vaidya), Author(Nicholas Rizzo), Author(Qi Liu))), ArxivEntry(http://arxiv.org/abs/1702.07476v3,Renyi Differential Privacy,We propose a natural relaxation of differential privacy based on the Renyi
...
tighter analysis of composite heterogeneous mechanisms.,2017-08-25T23:54:30Z,2017-02-24T06:46:38Z,List(Author(Ilya Mironov))), ArxivEntry(http://arxiv.org/abs/1703.02209v4,Certificate Transparency with Privacy,Certificate transparency (CT) is an elegant mechanism designed to detect when
...
non-public subdomains.,2017-08-07T16:05:26Z,2017-03-07T04:31:39Z,List(Author(Saba Eskandarian), Author(Eran Messeri), Author(Joseph Bonneau), Author(Dan Boneh))), ArxivEntry(http://arxiv.org/abs/1703.07949v3,Anonymized Local Privacy,In this paper, we introduce the family of Anonymized Local Privacy
...
over a real dataset as we scale the population.,2017-04-04T01:40:22Z,2017-03-23T07:15:55Z,List(Author(Joshua Joy), Author(Mario Gerla))), ArxivEntry(http://arxiv.org/abs/1704.03606v1,Privacy-Aware Guessing Efficiency,We investigate the problem of guessing a discrete random variable $Y$ under a
...
values of $\epsilon$.,2017-04-12T03:28:37Z,2017-04-12T03:28:37Z,List(Author(Shahab Asoodeh), Author(Mario Diaz), Author(Fady Alajaji), Author(Tamás Linder))), ArxivEntry(http://arxiv.org/abs/1707.07708v4,Per-instance Differential Privacy,We consider a refinement of differential privacy --- per instance
...
$(\epsilon,\delta)$-DP.,2018-11-14T07:11:31Z,2017-07-24T18:35:31Z,List(Author(Yu-Xiang Wang))), ArxivEntry(http://arxiv.org/abs/1707.09893v1,Quantum Privacy-Preserving Perceptron,With the extensive applications of machine learning, the issue of private or
...
requires no quantum database and thus is easy to implement.,2017-07-31T14:42:57Z,2017-07-31T14:42:57Z,List(Author(Shenggang Ying), Author(Mingsheng Ying), Author(Yuan Feng))), ArxivEntry(http://arxiv.org/abs/1708.01884v1,Differential Privacy By Sampling,In this paper we present the Sampling Privacy mechanism for privately
releasing personal data. Sampling Privacy is a sampling based privacy mechanism
that satisfies differential privacy.,2017-08-06T13:05:57Z,2017-08-06T13:05:57Z,List(Author(Josh Joy), Author(Mario Gerla))), ArxivEntry(http://arxiv.org/abs/1708.04726v1,Privacy-Enabled Biometric Search,Biometrics have a long-held hope of replacing passwords by establishing a
...
with speed, accuracy and privacy.,2017-08-16T00:25:11Z,2017-08-16T00:25:11Z,List(Author(Scott Streit), Author(Brian Streit), Author(Stephen Suffian))), ArxivEntry(http://arxiv.org/abs/1709.10124v1,Monogamy of Quantum Privacy,Quantum mechanics ensures that the information stored in a quantum state is
...
in future quantum networks.,2017-09-28T18:43:48Z,2017-09-28T18:43:48Z,List(Author(Arun Kumar Pati), Author(Kratveer Singh), Author(Manish K. Gupta))), ArxivEntry(http://arxiv.org/abs/1712.05888v1,One-sided Differential Privacy,In this paper, we study the problem of privacy-preserving data sharing,
...
over state-of-the-art DP-solutions.,2017-12-16T01:29:27Z,2017-12-16T01:29:27Z,List(Author(Stelios Doudalis), Author(Ios Kotsogiannis), Author(Samuel Haney), Author(Ashwin Machanavajjhala), Author(Sharad Mehrotra))), ArxivEntry(http://arxiv.org/abs/1712.07008v3,Privacy-Preserving Adversarial Networks,We propose a data-driven framework for optimizing privacy-preserving data
...
concealing the written digit.,2019-06-12T14:42:37Z,2017-12-19T15:53:45Z,List(Author(Ardhendu Tripathy), Author(Ye Wang), Author(Prakash Ishwar))), ArxivEntry(http://arxiv.org/abs/1712.08500v8,On Perfect Privacy,The problem of private data disclosure is studied from an information
...
shown that under mild conditions, this rate becomes unbounded.,2021-01-21T22:12:53Z,2017-12-22T15:16:40Z,List(Author(Borzoo Rassouli), Author(Deniz Gunduz))), ArxivEntry(http://arxiv.org/abs/1712.09136v1,Towards Measuring Membership Privacy,Machine learning models are increasingly made available to the masses through
...
published.,2017-12-25T22:23:28Z,2017-12-25T22:23:28Z,List(Author(Yunhui Long), Author(Vincent Bindschaedler), Author(Carl A. Gunter))), ArxivEntry(http://arxiv.org/abs/1806.00966v1,Segmentation, Incentives and Privacy,Data driven segmentation is the powerhouse behind the success of online
...
absence of a common prior.,2018-06-04T06:01:47Z,2018-06-04T06:01:47Z,List(Author(Kobbi Nissim), Author(Rann Smorodinsky), Author(Moshe Tennenholtz))), ArxivEntry(http://arxiv.org/abs/1806.04819v5,Integral Privacy for Sampling,Differential privacy is a leading protection setting, focused by design on
...
estimation and private GANs displays the quality of our results.,2019-07-02T22:41:35Z,2018-06-13T02:01:22Z,List(Author(Hisham Husain), Author(Zac Cranko), Author(Richard Nock))), ArxivEntry(http://arxiv.org/abs/1808.06651v2,Privacy Amplification by Iteration,Many commonly used learning algorithms work by iteratively updating an
...
that technique cannot be applied.,2018-12-10T23:43:40Z,2018-08-20T18:49:32Z,List(Author(Vitaly Feldman), Author(Ilya Mironov), Author(Kunal Talwar), Author(Abhradeep Thakurta))), ArxivEntry(http://arxiv.org/abs/1906.01337v6,SoK: Differential Privacies,Shortly after it was first introduced in 2006, differential privacy became
...
existing ones.,2022-11-13T21:39:01Z,2019-06-04T10:55:01Z,List(Author(Damien Desfontaines), Author(Balázs Pejó))), ArxivEntry(http://arxiv.org/abs/1907.02159v1,Capacity Bounded Differential Privacy,Differential privacy, a notion of algorithmic stability, is a gold standard
...
satisfy them.,2019-07-03T23:07:34Z,2019-07-03T23:07:34Z,List(Author(Kamalika Chaudhuri), Author(Jacob Imola), Author(Ashwin Machanavajjhala))), ArxivEntry(http://arxiv.org/abs/1907.07054v1,Location Privacy in Conservation,The growing public nature of academic journals along with current best
...
to published spatial data whilst allowing quantification of such tradeoff.,2019-07-16T15:11:48Z,2019-07-16T15:11:48Z,List(Author(Hayyu Imanda), Author(Joss Wright))), ArxivEntry(http://arxiv.org/abs/1909.04421v4,Privacy-Preserving Bandits,Contextual bandit algorithms~(CBAs) often rely on personal data to provide
...
approach to challenges arising in on-device privacy-preserving personalization.,2020-03-11T12:39:06Z,2019-09-10T11:39:58Z,List(Author(Mohammad Malekzadeh), Author(Dimitrios Athanasakis), Author(Hamed Haddadi), Author(Benjamin Livshits))), ArxivEntry(http://arxiv.org/abs/1910.07020v1,Privacy Preserving Count Statistics,The ability to preserve user privacy and anonymity is important. One of the
...
quantify the degree of anonymity the algorithm provides.,2019-10-15T19:42:00Z,2019-10-15T19:42:00Z,List(Author(Lu Yu), Author(Oluwakemi Hambolu), Author(Yu Fu), Author(Jon Oakley), Author(Richard R. Brooks))), ArxivEntry(http://arxiv.org/abs/1910.08385v1,Federated Generative Privacy,In this paper, we propose FedGP, a framework for privacy-preserving data
...
vulnerability of such models to model inversion attacks.,2019-10-18T12:41:15Z,2019-10-18T12:41:15Z,List(Author(Aleksei Triastcyn), Author(Boi Faltings))), ArxivEntry(http://arxiv.org/abs/1910.12820v5,Empirical Differential Privacy,We show how to achieve differential privacy with no or reduced added noise,
...
assumptions about the random process generating the data.,2023-01-03T23:14:52Z,2019-10-28T17:26:18Z,List(Author(Paul Burchard), Author(Anthony Daoud), Author(Dominic Dotterrer))), ArxivEntry(http://arxiv.org/abs/1911.09222v1,Privacy-Preserving Payment Splitting,Widely used payment splitting apps allow members of a group to keep track of
...
protocol enjoys excellent performance and scalability properties.,2019-11-20T23:53:23Z,2019-11-20T23:53:23Z,List(Author(Saba Eskandarian), Author(Mihai Christodorescu), Author(Payman Mohassel))), ArxivEntry(http://arxiv.org/abs/2005.11651v1,Successive Refinement of Privacy,This work examines a novel question: how much randomness is needed to achieve
...
preserving privacy of each user.,2020-05-24T04:16:01Z,2020-05-24T04:16:01Z,List(Author(Antonious M. Girgis), Author(Deepesh Data), Author(Kamalika Chaudhuri), Author(Christina Fragouli), Author(Suhas Diggavi))), ArxivEntry(http://arxiv.org/abs/2007.10361v2,Privacy Preserving Visual SLAM,This study proposes a privacy-preserving Visual SLAM framework for estimating
...
privacy-preserving formation and real-time performance using a line-cloud map.,2020-07-27T07:34:46Z,2020-07-20T18:00:06Z,List(Author(Mikiya Shibuya), Author(Shinya Sumikura), Author(Ken Sakurada))), ArxivEntry(http://arxiv.org/abs/2007.12633v1,Privacy vs National Security,There are growing concerns and anxiety about privacy among the general public
...
where a boundary should be drawn between privacy and national security.,2020-07-10T19:35:10Z,2020-07-10T19:35:10Z,List(Author(Tajdar Jawaid))), ArxivEntry(http://arxiv.org/abs/2007.12861v2,Adversarial Privacy-preserving Filter,While widely adopted in practical applications, face recognition has been
...
online multimedia sharing privacy-preserving issues from user side.,2020-08-04T05:12:11Z,2020-07-25T05:41:00Z,List(Author(Jiaming Zhang), Author(Jitao Sang), Author(Xian Zhao), Author(Xiaowen Huang), Author(Yanfeng Sun), Author(Yongli Hu))), ArxivEntry(http://arxiv.org/abs/2009.01364v1,Smart Meter Data Privacy,Smart grids (SGs) promise to deliver dramatic improvements compared to
...
disadvantages.,2020-09-02T21:59:03Z,2020-09-02T21:59:03Z,List(Author(Giulio Giaconi), Author(Deniz Gunduz), Author(H. Vincent Poor))), ArxivEntry(http://arxiv.org/abs/2009.05401v1,Multi-Central Differential Privacy,Differential privacy is typically studied in the central model where a
...
further research.,2020-09-11T12:47:27Z,2020-09-11T12:47:27Z,List(Author(Thomas Steinke))), ArxivEntry(http://arxiv.org/abs/2009.09035v3,Pretty Good Phone Privacy,To receive service in today's cellular architecture, phones uniquely identify
...
and location privacy.,2020-12-28T19:49:34Z,2020-09-18T19:27:49Z,List(Author(Paul Schmitt), Author(Barath Raghavan))), ArxivEntry(http://arxiv.org/abs/2011.04789v4,Privacy-Preserving XGBoost Inference,Although machine learning (ML) is widely used for predictive tasks, there are
...
algorithm is efficient enough to be used in real ML production environments.,2020-11-24T18:07:27Z,2020-11-09T21:46:07Z,List(Author(Xianrui Meng), Author(Joan Feigenbaum))), ArxivEntry(http://arxiv.org/abs/2101.12736v1,N-grams Bayesian Differential Privacy,Differential privacy has gained popularity in machine learning as a strong
...
protection.,2021-01-29T18:48:49Z,2021-01-29T18:48:49Z,List(Author(Osman Ramadan), Author(James Withers), Author(Douglas Orr))), ArxivEntry(http://arxiv.org/abs/2102.11158v1,Federated $f$-Differential Privacy,Federated learning (FL) is a training paradigm where the clients
...
{PriFedSync} in computer vision tasks.,2021-02-22T16:28:21Z,2021-02-22T16:28:21Z,List(Author(Qinqing Zheng), Author(Shuxiao Chen), Author(Qi Long), Author(Weijie J. Su))), ArxivEntry(http://arxiv.org/abs/2104.01987v2,Rejoinder: Gaussian Differential Privacy,In this rejoinder, we aim to address two broad issues that cover most
...
(GDP) can make a difference in a range of applications.,2021-06-26T02:40:17Z,2021-04-05T16:27:56Z,List(Author(Jinshuo Dong), Author(Aaron Roth), Author(Weijie J. Su))), ArxivEntry(http://arxiv.org/abs/2104.09779v1,Privacy-aware VR streaming,Proactive tile-based virtual reality (VR) video streaming employs the current
...
analysis and demonstrate the overall impact of DoP on the QoE.,2021-04-20T06:28:31Z,2021-04-20T06:28:31Z,List(Author(Xing Wei), Author(Chenyang Yang))), ArxivEntry(http://arxiv.org/abs/2104.14222v2,Privacy-Preserving Portrait Matting,Recently, there has been an increasing concern about the privacy issue raised
...
dataset are available at https://github.com/JizhiziLi/P3M,2021-07-29T13:07:00Z,2021-04-29T09:20:19Z,List(Author(Jizhizi Li), Author(Sihan Ma), Author(Jing Zhang), Author(Dacheng Tao))), ArxivEntry(http://arxiv.org/abs/2109.02768v2,Privacy-Preserving Database Fingerprinting,When sharing sensitive relational databases with other parties, a database
...
shared with multiple recipients.,2022-03-06T15:55:50Z,2021-09-06T22:50:51Z,List(Author(Tianxi Ji), Author(Erman Ayday), Author(Emre Yilmaz), Author(Pan Li))), ArxivEntry(http://arxiv.org/abs/2109.06990v1,Personalization, Privacy, and Me,News recommendation and personalization is not a solved problem. People are
...
experiences and privacy to reap the benefits of both.,2021-09-14T22:09:44Z,2021-09-14T22:09:44Z,List(Author(Reshma Narayanan Kutty), Author(Claudia Orellana-Rodriguez), Author(Igor Brigadir), Author(Ernesto Diaz-Aviles))), ArxivEntry(http://arxiv.org/abs/0803.3096v2,Physical Underpinnings of Privacy,One of the remarkable features of quantum mechanics is the ability to ensure
...
well as the direct quantum coding theorem.,2008-10-20T10:09:57Z,2008-03-20T23:46:03Z,List(Author(Joseph M. Renes), Author(Jean-Christian Boileau))), ArxivEntry(http://arxiv.org/abs/1508.00192v1,WaveCluster with Differential Privacy,WaveCluster is an important family of grid-based clustering algorithms that
...
and PrivTHREM achieve high utility when privacy budgets are properly allocated.,2015-08-02T04:41:51Z,2015-08-02T04:41:51Z,List(Author(Ling Chen), Author(Ting Yu), Author(Rada Chirkova))), ArxivEntry(http://arxiv.org/abs/1710.00447v5,Privacy with Estimation Guarantees,We study the central problem in data privacy: how to share data with an
...
illustrate the proposed approach through two numerical experiments.,2020-03-20T14:12:00Z,2017-10-02T01:14:10Z,List(Author(Hao Wang), Author(Lisa Vo), Author(Flavio P. Calmon), Author(Muriel Médard), Author(Ken R. Duffy), Author(Mayank Varia))), ArxivEntry(http://arxiv.org/abs/1710.03275v2,Privacy-preserving Targeted Advertising,Recommendation systems form the center piece of a rapidly growing trillion
...
manner. We base this approach on association rules.,2018-06-18T00:28:51Z,2017-10-09T19:31:22Z,List(Author(Theja Tulabandhula), Author(Shailesh Vaya), Author(Aritra Dhar))), ArxivEntry(http://arxiv.org/abs/1803.10266v2,Privacy-preserving Prediction,Ensuring differential privacy of models learned from sensitive user data is
...
we establish for all differentially private prediction algorithms.,2018-05-09T00:36:56Z,2018-03-27T18:40:05Z,List(Author(Cynthia Dwork), Author(Vitaly Feldman))), ArxivEntry(http://arxiv.org/abs/1807.05306v3,Generative Adversarial Privacy,We present a data-driven framework called generative adversarial privacy
...
evaluate GAP's performance on the GENKI face database.,2019-06-26T04:32:46Z,2018-07-13T23:40:33Z,List(Author(Chong Huang), Author(Peter Kairouz), Author(Xiao Chen), Author(Lalitha Sankar), Author(Ram Rajagopal))), ArxivEntry(http://arxiv.org/abs/1809.08911v2,Understanding Compressive Adversarial Privacy,Designing a data sharing mechanism without sacrificing too much privacy can
...
sensitive information.,2018-10-02T04:18:23Z,2018-09-21T07:39:50Z,List(Author(Xiao Chen), Author(Peter Kairouz), Author(Ram Rajagopal))), ArxivEntry(http://arxiv.org/abs/1809.10642v1,Privacy in Blockchain Systems,In this literature review, we first briefly provide an introduction on the
...
rate.,2018-09-27T17:07:44Z,2018-09-27T17:07:44Z,List(Author(Jad Wahab))), ArxivEntry(http://arxiv.org/abs/1901.02695v2,Incentivising Privacy in Cryptocurrencies,Privacy was one of the key points mentioned in Nakamoto's Bitcoin whitepaper,
...
poster can be found within this short document.,2019-01-11T14:25:12Z,2019-01-09T12:30:07Z,List(Author(Sarah Azouvi), Author(Haaroon Yousaf), Author(Alexander Hicks))), ArxivEntry(http://arxiv.org/abs/1901.09804v1,Is Privacy Controllable?,One of the major views of privacy associates privacy with the control over
...
and suggest directions for possible research.,2019-01-28T16:57:31Z,2019-01-28T16:57:31Z,List(Author(Yefim Shulman), Author(Joachim Meyer))), ArxivEntry(http://arxiv.org/abs/1905.02383v3,Gaussian Differential Privacy,Differential privacy has seen remarkable success as a rigorous and practical
...
by giving an improved privacy analysis of noisy stochastic gradient descent.,2019-05-30T23:51:04Z,2019-05-07T06:57:19Z,List(Author(Jinshuo Dong), Author(Aaron Roth), Author(Weijie J. Su))), ArxivEntry(http://arxiv.org/abs/2003.13897v1,Privacy-aware Data Trading,The growing threat of personal data breach in data trading pinpoints an
...
deteriorating privacy leakage.,2020-03-31T01:17:27Z,2020-03-31T01:17:27Z,List(Author(Shengling Wang), Author(Lina Shi), Author(Junshan Zhang), Author(Xiuzhen Cheng), Author(Jiguo Yu))), ArxivEntry(http://arxiv.org/abs/2006.05609v2,Learning With Differential Privacy,The leakage of data might have been an extreme effect on the personal level
...
trade-offs - will be discussed.,2020-06-11T14:11:44Z,2020-06-10T02:04:13Z,List(Author(Poushali Sengupta), Author(Sudipta Paul), Author(Subhankar Mishra))), ArxivEntry(http://arxiv.org/abs/2008.04477v1,Security Versus Privacy,Linear queries can be submitted to a server containing private data. The
...
under the differential privacy framework.,2020-08-11T02:04:58Z,2020-08-11T02:04:58Z,List(Author(Farhad Farokhi), Author(Peyman Mohajerin Esfahani))), ArxivEntry(http://arxiv.org/abs/2008.06430v1,Privacy Preserving Passive DNS,The Domain Name System (DNS) was created to resolve the IP addresses of the
...
the records.,2020-08-14T15:54:00Z,2020-08-14T15:54:00Z,List(Author(Pavlos Papadopoulos), Author(Nikolaos Pitropakis), Author(William J. Buchanan), Author(Owen Lo), Author(Sokratis Katsikas))), ArxivEntry(http://arxiv.org/abs/2012.05326v4,Privacy Amplification by Decentralization,Analyzing data owned by several parties while achieving a good trade-off
...
gradient descent.,2022-03-07T12:37:44Z,2020-12-09T21:33:33Z,List(Author(Edwige Cyffers), Author(Aurélien Bellet))), ArxivEntry(http://arxiv.org/abs/2012.05484v1,Preference-Based Privacy Trading,The question we raise through this paper is: Is it economically feasible to
...
for the purpose of targeted behavioral advertising.,2020-12-10T07:03:10Z,2020-12-10T07:03:10Z,List(Author(Ranjan Pal), Author(Yixuan Wang), Author(Swades De), Author(Bodhibrata Nag), Author(Pan Hui))))